    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.emailalarms" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/emailalarms/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><fmt:message code="common.object" /></th>
                                        <th><fmt:message code="common.name" /></th>
                                        <th><fmt:message code="common.position" /></th>
                                        <th><fmt:message code="common.mail" /></th>
                                        <th><fmt:message code="common.company" /></th>
                                    </tr>
                                </thead>
                                <tbody>
                                	<c:forEach items="${EmailAlarms}" var = "EmailAlarms">
	                                    <tr class="odd gradeX">
	                                        <td>${EmailAlarms.getIdemail_alarms().getObject() }</td>
	                                        <td>${EmailAlarms.getIdemail_alarms().getName() }</td>
	                                        <td>${EmailAlarms.getPosition() }</td>
	                                        <td>${EmailAlarms.getIdemail_alarms().getMail() }</td>
	                                        <td>${EmailAlarms.getCompany() }</td>
