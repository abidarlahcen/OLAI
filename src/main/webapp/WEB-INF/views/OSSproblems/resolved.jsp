    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Resloved issues</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	<c:forEach items="${solvedproblems}" var = "solvedproblems">
	                                    <tr class="odd gradeX">
	                                        <td>${solvedproblems.getProblemid() }</td>
	                                        <td>${solvedproblems.getProblem() }</td>
	                                        <td>${solvedproblems.getMail_send_to() }</td>
	                                        <td>${solvedproblems.getProblem_source() }</td>
	                                        <td>${solvedproblems.getProposed_solution() }</td>
