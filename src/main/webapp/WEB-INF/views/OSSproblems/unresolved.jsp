    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Unresolved issues</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><fmt:message code="common.problemid" /></th>
                                        <th><fmt:message code="common.problem" /></th>
                                        <th><fmt:message code="common.mail_send_to" /></th>
                                        <th><fmt:message code="common.problem_source" /></th>
                                        <th><fmt:message code="common.proposed_solution" /></th>
                                    </tr>
                                </thead>
                                <tbody>
                                	<c:forEach items="${unsolvedproblems}" var = "unsolvedproblems">
	                                    <tr class="odd gradeX">
	                                        <td>${unsolvedproblems.getProblemid() }</td>
	                                        <td>${unsolvedproblems.getProblem() }</td>
	                                        <td>${unsolvedproblems.getMail_send_to() }</td>
	                                        <td>${unsolvedproblems.getProblem_source() }</td>
	                                        <td>${unsolvedproblems.getProposed_solution() }</td>
